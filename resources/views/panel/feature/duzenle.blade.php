                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('feature.update',$feature->id)}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="propert_type_id" id="exampleFormControlSelect1">
                                    @foreach ($propertyTypes as $propertyType)
                                    <option value="{{$propertyType->id}}" {{ $feature->propert_type_id ==
                                        $propertyType->id ? 'selected' : '' }}>{{$propertyType->name}}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="status" id="exampleFormControlSelect1">
                                    <option {{$feature->status == 1 ? "selected" : null}} value="1">Aktif</option>
                                    <option {{$feature->status == 0 ? "selected" : null}} value="0">Deaktif</option>
                                </select>
                            </div>
