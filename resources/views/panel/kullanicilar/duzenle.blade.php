                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('kullanici.update', $user->id)}}" method="post">
                            ...
                            <div class="form-group m-t-40 row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" name="name" type="text" id="example-text-input" value="{{$user->name}}">
                                </div>
                            </div>
                            <div class="form-group m-t-40 row">
                                <label for="example-text-input" class="col-2 col-form-label">Soyadı</label>
                                <div class="col-10">
                                    <input class="form-control" name="surname" type="text" id="example-text-input" value="{{$user->surname}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="example-search-input" class="col-2 col-form-label">Telefon No</label>
                                <div class="col-10">
                                    <input class="form-control" name="phone" type="tel" id="example-search-input" value="{{$user->phone}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control"  type="email" disabled
                                        id="example-email-input" value="{{$user->email}}">
                                </div>
                            </div>
                            <div class="form-group row">
