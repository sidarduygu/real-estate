        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <a type="button" href="{{route('property-feature.create')}}" class="btn btn-info d-none d-lg-block m-l-15"><i
        ...
        <table class="table table">
            ...
            <tbody>
                ...
                <tr class="table-primary">
                    ...
                    <td>{{$propertyFeature->property_id}}</td>
                    <td>{{$propertyFeature->feature_id}}</td>
                    <td>{{$propertyFeature->value}}</td>
                      <div>
                        <div class="btn-group">
